					...
					?>
							<tr class="odd gradeX">
								...
								<td>
									...
									?>
									<a href="?type_slider=<?php echo $result_slider['slider_id'] ?>&type=0">On</a>
									<?php 
									}else{
									?>
									<a href="?type_slider=<?php echo $result_slider['slider_id'] ?>&type=1">Off</a>
									<?php 
									}
									?>
								</td>
								<td>
									<a href="?slider_del=<?php echo $result_slider['slider_id'] ?>" onclick="return confirm('Are you sure to Delete!');">Delete</a>
								</td>
							</tr>
					<?php
